    ...
    <footer className="mt-auto pt-2 text-sm text-muted-foreground" role="contentinfo" aria-label="Project source">
      ...
      <div className="flex flex-col items-center gap-2 py-6 text-center leading-6">
        <p className="m-0 text-center leading-6">
          <span>Built by{' '}<Button asChild className="h-7 align-middle px-0 text-sm text-foreground" size="sm" variant="link"><a href="https://ashwingopalsamy.in" target="_blank" rel="noopener noreferrer">Ashwin Gopalsamy</a></Button>.{' '}</span>
          <span>The source code is available on{' '}<Button asChild className="h-7 align-middle items-center gap-1 px-1 text-sm text-foreground" size="sm" variant="link">
          ...
          </Button>{' '}and the dataset is available in{' '}<Button asChild className="h-7 align-middle items-center gap-1 px-1 text-sm text-foreground" size="sm" variant="link">

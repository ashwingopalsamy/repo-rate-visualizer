              ...
              <div className="workspace-controls__grid">
                ...
                <div className="workspace-control-group" data-control-group="view">
                  ...
                  <Tabs className="min-w-0 w-full" value={activeView} onValueChange={onViewChange}>
                    <TabsList aria-label="Analytical views" className="workspace-view-switcher__list max-w-full overflow-x-auto gap-1">
                      {VIEWS.map(view => (
                        <TabsTrigger className="workspace-view-switcher__trigger px-2.5 sm:px-3 text-xs sm:text-sm" key={view.id} value={view.id}>
                          {view.label}
                        </TabsTrigger>
                      ))}
                    </TabsList>

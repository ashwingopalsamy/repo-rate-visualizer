...
- Interactive controls and buttons use unified rounded rectangles; grouped rails and large surfaces use generous
  concentric radii. Tables remain rectangular inside a rounded outer frame.
- Inter is the interface and current-rate face. JetBrains Mono is restricted to
...
- The snapshot is the first-viewport focal point: `5.25` is a calm Inter display
...
- Controls, buttons, and semantic badges use unified rounded rectangles; grouped control rails and the
